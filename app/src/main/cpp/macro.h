...
//打不开媒体数据源
#define ERROR_CAN_NOT_OPEN_URL (ERROR_CODE_FFMPEG_PREPARE - 1)
//找不到媒体流信息
...
//读取媒体数据包失败
#define ERROR_READ_PACKETS_FAIL (ERROR_CODE_FFMPEG_PLAY -1)
#define ERROR_SEEK_TO (ERROR_CODE_FFMPEG_PLAY -2)
